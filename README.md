...
Below are data samples and the results of the MC-DART experiments:
   ...
   <p align="center">
   <img src="./images/Nx128Nclass50Nchan1run1CONVERTEDmat2.png" style="width: 25%">
   <img src="./images/EXP1PixelErrorOverMaterialsandChannels.png" style="width: 50%">
   </p>
   <p align="center">
   <img src="./images/Nx128Nclass50Nchan1run1CONVERTEDmat10.png" style="width: 25%">
   <img src="./images/EXP2PixelErrorOverTime.png" style="width: 50%">
   </p>
